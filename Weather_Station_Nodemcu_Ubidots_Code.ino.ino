 ...
 * last updated - time 05:04 PM - date 24 may 2021
...
const char* UBIDOTS_TOKEN = "PASTE UBIDOTS TOKEN"; 
...
int Altitude = doc["Altitude"];
  ...
  ubidots.add("Smoke", mq2_value); 
  ubidots.add("Cng", mq4_value);
  ubidots.add("Lpg", mq5_value); 
  ubidots.add("Air Quality", mq135_value);
  ubidots.add("Rain", rain_value); 
  ubidots.add("Temperature", t); 
  ubidots.add("Humidity", h);
  ubidots.add("Light", ldrvalue);
  ...
  if (bufferSent) {
   Serial.println("Values Was Sent To UBIDOTS !");
  }
